	...
	<div class="cbr_tab_inner_container">
		<div class="cbr-pro-tab-content">
			<div class="cbr-pro-tab-overlay">
				<h3><?php esc_html_e( 'Catalog Restrictions', 'woo-product-country-base-restrictions' ); ?> <span class="cbr-pro-badge"><?php esc_html_e( 'PRO', 'woo-product-country-base-restrictions' ); ?></span> <span class="cbr-pro-lock"><span class="dashicons dashicons-lock"></span></span></h3>
				<p><?php esc_html_e( 'Create bulk restriction rules to restrict products by categories, tags, attributes, and shipping classes for specific countries. Upgrade to PRO to unlock this feature.', 'woo-product-country-base-restrictions' ); ?></p>
						...
						<tr valign="top">
							<td class="bulk-data-table" style="padding: 0;">
								<div style="padding: 15px;">
									<!-- Sample restriction rule preview -->
									<div class="accordion" style="background: #fafafa; border: 1px solid #e0e0e0; border-radius: 3px; padding: 12px 15px; margin-bottom: 10px;">
										<span style="display: flex; align-items: center; justify-content: space-between;">
											<span style="display: flex; align-items: center; gap: 10px;">
												<span style="font-weight: 600; color: #3c4758;"><?php esc_html_e( 'Restrictions Rule 1', 'woo-product-country-base-restrictions' ); ?></span>
												<span style="color: #999; font-size: 13px;"><?php esc_html_e( 'By Categories', 'woo-product-country-base-restrictions' ); ?></span>
											</span>
									...
									<div class="accordion" style="background: #fafafa; border: 1px solid #e0e0e0; border-radius: 3px; padding: 12px 15px; margin-bottom: 10px;">
										<span style="display: flex; align-items: center; justify-content: space-between;">
											<span style="display: flex; align-items: center; gap: 10px;">
												<span style="font-weight: 600; color: #3c4758;"><?php esc_html_e( 'Restrictions Rule 2', 'woo-product-country-base-restrictions' ); ?></span>
												<span style="color: #999; font-size: 13px;"><?php esc_html_e( 'By Tags', 'woo-product-country-base-restrictions' ); ?></span>
											</span>
											<span style="display: flex; align-items: center; gap: 8px;">
												<span class="dashicons dashicons-menu" style="color: #999;"></span>
												<span class="dashicons dashicons-no-alt" style="color: #999;"></span>
