...
class CBR_Admin_Notice {
	...
	*/
	 ...
	 * @since 1.0.0
	 */
	public function cbr_pro_admin_notice() {
		if ( class_exists( 'Country_Based_Restrictions_PRO_Add_on' ) ) {
			return;
		}
		
		if ( get_option('Cbr_Pro_Plugin_Promotion_Notice') ) {
			return;
		}
		...
		echo '<div class="updated notice"><h3 style="margin-bottom: 0;">Country Based Restriction Pro</h3><p>' . esc_html( $message ) . ' 
